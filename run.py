...
parser.add_argument('--epochs', type=int, default=50,  help='How many training epochs?')
...
header3 = "** LR Config: Init_l: {} | Init_l: {} | Peak: {} | Warmup Epoch: {} | Rise: {} | Decay {} | train params {} | all params {} **".format([float(f'{sch.get_last_lr()[0]:.6f}') for sch in lr_schedulers_l], [float(f'{sch.get_last_lr()[0]:.6f}') for sch in lr_schedulers_r], [float(f'{v:.6f}') for v in wp_lr], warmups, power, decay_rate, pytorch_train_params, pytorch_total_params)
